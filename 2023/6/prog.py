...
def problem_2():
    ...
    while low_index <= high_index:
        ...
        if curr_time.distance <= target_distance and next_time.distance > target_distance:
            print("start of wins found")
            print("current_time", curr_time)
            print("next_time", next_time)
            break # Target found, return the index
        elif curr_time.distance < target_distance and next_time.distance <= target_distance:
